#!/usr/bin/python
# Vendored from https://github.com/elastic/ember/blob/d97a0b5/ember/features.py (AGPL-3.0).
# Local changes, only for compatibility with current dependencies (feature semantics unchanged):
...
class PEFeatureExtractor(object):
    ...
    def raw_features(self, bytez):
        lief_errors = (RuntimeError,)  # lief >= 0.13 returns None instead of raising on parse errors
        try:
